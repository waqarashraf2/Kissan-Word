...
<section class="inner-section section-shell product-detail">
    <div class="product-gallery" data-product-detail-gallery data-gallery-images='@json($galleryImages)'>
        <div class="product-main-image"><img src="{{ $galleryImages->first()['src'] }}" alt="{{ $galleryImages->first()['alt'] }}" data-gallery-main></div>
...
<section class="product-description-section section-shell">
    ...
    <div class="description-columns {{ $product->description_ur ? 'has-urdu' : '' }}">
        @if($product->description)<div class="product-description"><h3>Product description</h3><div>{!! nl2br(e($product->description)) !!}</div></div>@endif
        @if($product->description_ur)<div class="product-description urdu-description" lang="ur" dir="rtl"><h3>مصنوعات کی تفصیل</h3><div>{!! nl2br(e($product->description_ur)) !!}</div></div>@endif
    </div>
</section>
@endif
